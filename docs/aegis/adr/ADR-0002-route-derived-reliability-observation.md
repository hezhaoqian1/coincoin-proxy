...
The realtime monitoring page, ops health page, embedded manual monitor manager, and their dead JavaScript/CSS are retired. Persistent monitor/history rows are retained; monitored channels disable instead of hard-deleting.
