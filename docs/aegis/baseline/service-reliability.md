...
- Retained: `extra_models` persistence/API compatibility, manual monitor APIs, protected external probes, monitor/history tables, disabled redundant monitor rows, and existing router behavior.
