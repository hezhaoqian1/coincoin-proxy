...
- DeepSeek public aliases such as `deepseek-v4-pro` and `deepseek-v4-flash` are route-only. Operators must attach them to a New API/OpenAI-compatible provider channel before customer traffic can use them.
