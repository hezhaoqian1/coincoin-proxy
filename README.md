...
- 旧 GPT lane 当前公开 alias 包括 `gpt-5`、`gpt-5.1`、`gpt-5.1-codex`、`gpt-5.1-codex-mini`、`gpt-5.1-codex-max`、`gpt-5.2`、`gpt-5.2-codex`、`gpt-5.3-codex`、`codex-auto-review`、`gpt-5.4-mini`、`gpt-5-codex`、`gpt-5-codex-mini`，以及由 `COINCOIN_FIXED_MODEL` 指定的默认 GPT alias
...
更完整的后台操作 runbook 见 [Provider Channel Routing Runbook](/Users/hezhaoqian/Desktop/codex_transfer_station/docs/operations/provider-channel-routing-runbook.md)。
...
- [Provider Channel Routing Runbook](/Users/hezhaoqian/Desktop/codex_transfer_station/docs/operations/provider-channel-routing-runbook.md)
