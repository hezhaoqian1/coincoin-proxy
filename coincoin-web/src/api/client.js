...
export const PUBLIC_MODEL_CATALOG_FALLBACK = [
    { id: 'gpt-5.2-codex', object: 'model', owned_by: 'openai', coincoin_provider: 'OpenAI', coincoin_provider_model: 'gpt-5.2-codex', coincoin_capabilities: ['chat/completions', 'responses', 'embeddings'], coincoin_billable_sku: 'legacy-default-text', coincoin_routing_mode: 'legacy_auto', coincoin_default_for: ['text'], coincoin_metadata: { tier: 'stable' }, coincoin_price_input_per_million: 99, coincoin_price_output_per_million: 699, coincoin_price_per_image_cents: 0 },
