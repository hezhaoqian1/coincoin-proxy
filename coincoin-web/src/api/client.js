...
export const PUBLIC_MODEL_CATALOG_FALLBACK = [
    { id: 'claude-fable-5-1', object: 'model', owned_by: 'anthropic', coincoin_capabilities: ['chat/completions'], coincoin_billable_sku: 'claude-fable-5-1-text', coincoin_routing_mode: 'route_only', coincoin_delivery_lane: 'route_only', coincoin_default_for: [], coincoin_metadata: { tier: 'stable', display_name: 'Claude Fable 5.1', official_price_source: 'Anthropic Claude pricing', context_length: 1000000, max_completion_tokens: 128000 }, coincoin_price_input_per_million: 1000, coincoin_price_cached_input_per_million: 25, coincoin_price_cache_creation_input_per_million: 1250, coincoin_cache_creation_multiplier: 1.25, coincoin_cache_read_multiplier: 0.025, coincoin_price_output_per_million: 5000, coincoin_price_per_image_cents: 0 },
    { id: 'claude-opus-5-5', object: 'model', owned_by: 'anthropic', coincoin_capabilities: ['chat/completions'], coincoin_billable_sku: 'claude-opus-5-5-text', coincoin_routing_mode: 'route_only', coincoin_delivery_lane: 'route_only', coincoin_default_for: [], coincoin_metadata: { tier: 'stable', display_name: 'Claude Opus 5.5', version: 'Claude Opus 5.5', provider_protocol: 'anthropic_messages', context_length: 1000000, max_completion_tokens: 128000, supported_parameters: ['tools', 'vision'], official_model_source: 'https://platform.claude.com/docs/en/models/opus-5-5/overview' }, coincoin_price_input_per_million: 400, coincoin_price_cached_input_per_million: 20, coincoin_price_cache_creation_input_per_million: 500, coincoin_cache_creation_multiplier: 1.25, coincoin_cache_read_multiplier: 0.05, coincoin_price_output_per_million: 2000, coincoin_price_per_image_cents: 0 },
    { id: 'claude-opus-5', object: 'model', owned_by: 'anthropic', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'claude-code-compat-text', coincoin_routing_mode: 'route_only', coincoin_delivery_lane: 'route_only', coincoin_default_for: [], coincoin_metadata: { tier: 'stable', display_name: 'Claude Opus 5', official_price_source: 'Anthropic Claude pricing', context_length: 1000000, max_completion_tokens: 128000 }, coincoin_price_input_per_million: 500, coincoin_price_cached_input_per_million: 50, coincoin_price_cache_creation_input_per_million: 625, coincoin_cache_creation_multiplier: 1.25, coincoin_cache_read_multiplier: 0.1, coincoin_price_output_per_million: 2500, coincoin_price_per_image_cents: 0 },
    { id: 'claude-opus-4-8', object: 'model', owned_by: 'coincoin', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'claude-code-compat-text', coincoin_routing_mode: 'direct', coincoin_delivery_lane: 'upstream_direct', coincoin_default_for: [], coincoin_metadata: { tier: 'stable', official_price_source: 'Anthropic Claude pricing' }, coincoin_price_input_per_million: 500, coincoin_price_cached_input_per_million: 50, coincoin_price_output_per_million: 2500, coincoin_price_per_image_cents: 0 },
    { id: 'claude-opus-4.8', object: 'model', owned_by: 'coincoin', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'claude-code-compat-text', coincoin_routing_mode: 'direct', coincoin_delivery_lane: 'upstream_direct', coincoin_default_for: [], coincoin_metadata: { tier: 'stable', official_price_source: 'Anthropic Claude pricing' }, coincoin_price_input_per_million: 500, coincoin_price_cached_input_per_million: 50, coincoin_price_output_per_million: 2500, coincoin_price_per_image_cents: 0 },
    { id: 'grok-4.5', object: 'model', owned_by: 'xai', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'xai-grok-4.5-text', coincoin_routing_mode: 'route_only', coincoin_delivery_lane: 'route_only', coincoin_default_for: [], coincoin_metadata: { tier: 'stable', display_name: 'Grok 4.5', context_length: 500000, supported_parameters: ['stream', 'reasoning_effort', 'tools', 'vision'] }, coincoin_price_input_per_million: 500, coincoin_price_cached_input_per_million: 50, coincoin_price_output_per_million: 3000, coincoin_price_per_image_cents: 0 },
    { id: 'grok-4.6', object: 'model', owned_by: 'xai', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'xai-grok-4.6-text', coincoin_routing_mode: 'route_only', coincoin_delivery_lane: 'route_only', coincoin_default_for: [], coincoin_metadata: { tier: 'stable', display_name: 'Grok 4.6', context_length: 500000, supported_parameters: ['stream', 'reasoning_effort', 'tools', 'vision'] }, coincoin_price_input_per_million: 500, coincoin_price_cached_input_per_million: 50, coincoin_price_output_per_million: 3000, coincoin_price_per_image_cents: 0 },
    { id: 'grok-build', object: 'model', owned_by: 'xai', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'xai-grok-build-text', coincoin_routing_mode: 'route_only', coincoin_delivery_lane: 'route_only', coincoin_default_for: [], coincoin_metadata: { tier: 'stable', display_name: 'Grok Build', context_length: 500000, preferred_api_backend: 'responses', supported_parameters: ['stream', 'reasoning_effort', 'tools', 'vision'] }, coincoin_price_input_per_million: 500, coincoin_price_cached_input_per_million: 50, coincoin_price_output_per_million: 3000, coincoin_price_per_image_cents: 0 },
    { id: 'gpt-5.5', object: 'model', owned_by: 'openai', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'legacy-gpt-5.5-text', coincoin_routing_mode: 'legacy_auto', coincoin_default_for: ['text'], coincoin_metadata: {}, coincoin_price_input_per_million: 500, coincoin_price_cached_input_per_million: 50, coincoin_price_output_per_million: 3000, coincoin_price_per_image_cents: 0 },
    { id: 'gpt-6-sol', object: 'model', owned_by: 'openai', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'legacy-gpt-6-sol-text', coincoin_routing_mode: 'legacy_auto', coincoin_delivery_lane: 'legacy', coincoin_default_for: [], coincoin_metadata: { display_name: 'GPT-6 Sol', version: 'gpt-6', description: 'OpenAI model for complex coding and agentic workflows.', context_length: 1050000, max_completion_tokens: 128000, supported_parameters: ['tools', 'vision', 'reasoning_effort'], thinking: { default: 'medium', levels: ['none', 'low', 'medium', 'high', 'xhigh', 'max'] }, official_model_source: 'https://developers.openai.com/api/docs/models/gpt-6-sol' }, coincoin_price_input_per_million: 200, coincoin_price_cached_input_per_million: 20, coincoin_price_cache_creation_input_per_million: 250, coincoin_cache_creation_multiplier: 1.25, coincoin_price_output_per_million: 1000, coincoin_price_per_image_cents: 0 },
    { id: 'gpt-6-luna', object: 'model', owned_by: 'openai', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'legacy-gpt-6-luna-text', coincoin_routing_mode: 'legacy_auto', coincoin_delivery_lane: 'legacy', coincoin_default_for: [], coincoin_metadata: { display_name: 'GPT-6 Luna', version: 'gpt-6', description: 'OpenAI model for efficient, high-volume workloads.', context_length: 1050000, max_completion_tokens: 128000, supported_parameters: ['tools', 'vision', 'reasoning_effort'], thinking: { default: 'medium', levels: ['none', 'low', 'medium', 'high', 'xhigh', 'max'] }, official_model_source: 'https://developers.openai.com/api/docs/models/gpt-6-luna' }, coincoin_price_input_per_million: 10, coincoin_price_cached_input_per_million: 1, coincoin_price_cache_creation_input_per_million: 12.5, coincoin_cache_creation_multiplier: 1.25, coincoin_price_output_per_million: 50, coincoin_price_per_image_cents: 0 },
    { id: 'codex-auto-review', object: 'model', owned_by: 'openai', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'legacy-codex-auto-review-text', coincoin_routing_mode: 'legacy_auto', coincoin_default_for: [], coincoin_metadata: { display_name: 'Codex Auto Review', description: 'Automatic approval review model for Codex.', supported_parameters: ['tools'], thinking: { levels: ['low', 'medium', 'high', 'xhigh'] } }, coincoin_price_input_per_million: 500, coincoin_price_cached_input_per_million: 50, coincoin_price_output_per_million: 3000, coincoin_price_per_image_cents: 0 },
    { id: 'gpt-5.6', object: 'model', owned_by: 'openai', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'legacy-gpt-5.6-sol-text', coincoin_routing_mode: 'legacy_auto', coincoin_metadata: {}, coincoin_price_input_per_million: 500, coincoin_price_cached_input_per_million: 50, coincoin_price_output_per_million: 3000, coincoin_price_per_image_cents: 0 },
    { id: 'gpt-5.6-sol', object: 'model', owned_by: 'openai', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'legacy-gpt-5.6-sol-text', coincoin_routing_mode: 'legacy_auto', coincoin_metadata: {}, coincoin_price_input_per_million: 500, coincoin_price_cached_input_per_million: 50, coincoin_price_output_per_million: 3000, coincoin_price_per_image_cents: 0 },
    { id: 'gpt-5.6-terra', object: 'model', owned_by: 'openai', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'legacy-gpt-5.6-terra-text', coincoin_routing_mode: 'legacy_auto', coincoin_metadata: {}, coincoin_price_input_per_million: 200, coincoin_price_cached_input_per_million: 20, coincoin_price_output_per_million: 1200, coincoin_price_per_image_cents: 0 },
    { id: 'gpt-5.6-luna', object: 'model', owned_by: 'openai', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'legacy-gpt-5.6-luna-text', coincoin_routing_mode: 'legacy_auto', coincoin_metadata: {}, coincoin_price_input_per_million: 20, coincoin_price_cached_input_per_million: 2, coincoin_price_output_per_million: 120, coincoin_price_per_image_cents: 0 },
    { id: 'gpt-6', object: 'model', owned_by: 'openai', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'legacy-gpt-6-astra-text', coincoin_routing_mode: 'legacy_auto', coincoin_metadata: { display_name: 'GPT-6 Astra' }, coincoin_price_input_per_million: 1000, coincoin_price_cached_input_per_million: 100, coincoin_price_output_per_million: 5000, coincoin_price_per_image_cents: 0 },
    { id: 'gpt-6-astra', object: 'model', owned_by: 'openai', coincoin_capabilities: ['chat/completions', 'responses'], coincoin_billable_sku: 'legacy-gpt-6-astra-text', coincoin_routing_mode: 'legacy_auto', coincoin_metadata: { display_name: 'GPT-6 Astra' }, coincoin_price_input_per_million: 1000, coincoin_price_cached_input_per_million: 100, coincoin_price_output_per_million: 5000, coincoin_price_per_image_cents: 0 },
    ...
    { id: 'gpt-image-2.5', object: 'model', owned_by: 'openai', coincoin_capabilities: ['images/generations', 'images/edits'], coincoin_billable_sku: 'openai-image-2.5', coincoin_routing_mode: 'direct', coincoin_delivery_lane: 'upstream_direct', coincoin_default_for: [], coincoin_metadata: { tier: 'preview', upstream_billing_mode: 'per_image', official_price_source: 'OpenAI image generation pricing', official_price_basis: 'Official image token rates are reference only; this upstream charges per output image' }, coincoin_price_input_per_million: 0, coincoin_price_output_per_million: 0, coincoin_price_per_image_cents: 80 },
...
export function describePublicModel(model) {
    ...
    if (capabilities.includes('images/generations') || capabilities.includes('images/edits')) {
        ...
        if (id === 'gpt-image-2.5') return 'GPT Image 2.5 图片模型，按输出张数计费，支持文生图和图生图'
    ...
    if (['claude-fable-5-1', 'claude-opus-5-5', 'claude-opus-5', 'claude-opus-4-8', 'claude-opus-4-7', 'best', 'default', 'opus[1m]', 'opusplan'].includes(id)) {
        return '高质量文本模型，适合复杂代码生成、重构和 agent 工作流'
    }
    if (['claude-sonnet-4-6', 'claude-haiku-4-5', 'claude-haiku-4-5-20251001', 'sonnet[1m]'].includes(id)) {
        return '快速文本模型，适合低延迟、多轮对话和批量任务'
    }
    if (id === 'grok-build') {
        return 'Grok Build 编程代理模型，支持 Responses、流式输出、推理和完整函数工具回路'
    }
    if (id.startsWith('grok-')) {
        return 'xAI Grok 推理模型，支持对话、视觉理解、流式输出和工具调用'
    }
    if (id.startsWith('gpt-6')) {
        if (id.endsWith('-luna')) return '高性价比文本模型，适合低延迟、高吞吐和批量任务'
        return '高质量推理与编程模型，适合复杂代码生成和 agent 工作流'
    }
