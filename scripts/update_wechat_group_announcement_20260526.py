#!/usr/bin/env python3
"""Publish the 2026-07-16 CoinCoin WeChat group announcement.
...
DEFAULT_IMAGE_URL = "/wechat-group-coincoin-2026-07-16.jpg?v=20260716-1"
ANNOUNCEMENT_TEMPLATE: dict[str, Any] = {
    "title": "进群再领 $10",
    "content": (
        "加入 Life Coding 交流群 02，联系管理员领取额外 $10 API 额度。"
        "该二维码 7 月 23 日前有效，过期后可复制微信号 birdsync。"
    ),
    "priority": "info",
    "display_type": "modal",
    "audience": "all",
