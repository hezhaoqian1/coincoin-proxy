...
CLAUDE_FABLE_INPUT_PRICE_PLACEHOLDER = "${COINCOIN_CLAUDE_FABLE_INPUT_PRICE:-3000}"
CLAUDE_FABLE_OUTPUT_PRICE_PLACEHOLDER = "${COINCOIN_CLAUDE_FABLE_OUTPUT_PRICE:-15000}"
CLAUDE_OPUS_ALIASES = {
    "claude-opus-4-8",
    "claude-opus-4.8",
    "claude-opus-4-7",
